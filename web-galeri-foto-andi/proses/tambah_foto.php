...
if (isset($_POST['tambah'])) {
    ...
    $sql = "INSERT INTO foto (judul_foto, deskripsi_foto, lokasi_foto, lokasi_file, tanggal_upload, id_user) VALUES ('$judul_foto', '$deskripsi_foto', '$lokasi_foto', '$nama_baru', '$tanggal_upload', '$id_user')";
